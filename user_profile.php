                ...
                <div class="col-lg-3">
                    <div class="all_tabs">
                        ...
                        <ul class="nav nav-tabs tabs_side_bar" id="myTab" role="tablist">
                            ...
                            <li class="nav-item tabs_button_wrapper " role="presentation">
                                <button class="tabs_controller" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab" aria-controls="contact" aria-selected="false">Contact</button>
                            </li>
                        </ul>
                    </div>
                </div>
                                    ...
                                    <div class="booking_top">
                                        ...
                                        <div class="toogle_bookings">
                                            <div class="button_group">
                                                <button id="pending_booking_btn" class="tab_btn">Pending Bookings</button>
                                                <button class="active tab_btn" id="previous_booking_btn">Previous Bookings</button>
                                                <button id="upcoming_booking_btn" class="tab_btn">Upcoming Bookings</button>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><button class="view_detail">View Detail</button></td>
                                                    </tr>
                                                    <tr>
                                                        <td>#6519576</td>
                                                        <td>22-25 june 22</td>
